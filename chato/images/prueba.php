...
<head>
  ...
  <link rel ="stylesheet" href="asdfasdfasfdsdfasdfa/style.css">
  <script
...
<body>
 <section>
     ...
     <header>
         <a href="#"><img src="locoempresa2.png"  class="logo"></a>
            <ul>
                <li><a href="#">Home</a></li>
                <li><a href="#">Menu</a></li>
     ...
     <div class="content">
         <div class="textBox">
             ...
             <a href="#" onmouseover="imgSlider('coserhandsdef.jpg'); changeCircleColor('#FFD359');changeDescription(1)">Learn More</a>
             <a href="#" onmouseover="imgSlider('diseñodef.jpg'); changeCircleColor('#FFDC7D');changeDescription(2)">Learn More</a>
             <a href="#" onmouseover="imgSlider('patronaje2def.jpg'); changeCircleColor('#F9C537');changeDescription(3)">Learn More</a>
             <a href="#" onmouseover="imgSlider('modelaje2maybe2def.jpg'); changeCircleColor('#FFD359');changeDescription(4)">Learn More</a>
         </div>
         <div class="imgBox">
